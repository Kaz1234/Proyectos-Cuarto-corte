...
void Cifrado_de_cesar_graficoFrm::CreateGUIControls()
{
	...
	WxStaticText1 = new wxStaticText(this, ID_WXSTATICTEXT1, _("N° Desplazaiento"), wxPoint(52, 12), wxDefaultSize, 0, _("WxStaticText1"));
	...
	WxButton2 = new wxButton(this, ID_WXBUTTON2, _("Descifrar texto"), wxPoint(290, 8), wxSize(108, 25), 0, wxDefaultValidator, _("WxButton2"));

	WxButton1 = new wxButton(this, ID_WXBUTTON1, _("Cifrar texto"), wxPoint(195, 9), wxSize(81, 25), 0, wxDefaultValidator, _("WxButton1"));
